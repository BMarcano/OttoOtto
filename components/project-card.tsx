...
export function ProjectCard({
  ...
  return (
    <div
  id={`project-card-${id}`}
  className={`flex flex-col h-full bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden rounded-lg transform ${
